...
//! Project version number for NTImageProcessing.
FOUNDATION_EXPORT double NTImageProcessingVersionNumber;

//! Project version string for NTImageProcessing.
FOUNDATION_EXPORT const unsigned char NTImageProcessingVersionString[];
